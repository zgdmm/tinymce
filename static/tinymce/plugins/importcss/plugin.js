...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_ekvy56f0jivb5dsk.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_ekvy56f0jivb5dsk.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_ekvy56f0jivb5dsk.getSelectorConverter(editor)) {
      selectorConverter = $_ekvy56f0jivb5dsk.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_ekvy56f0jivb5dsk.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_ekvy56f0jivb5dsk.getCssGroups(editor));
      ...
      if (!$_ekvy56f0jivb5dsk.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_ekvy56f0jivb5dsk.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_436tf9evjivb5dsd.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_e588q3eujivb5ds9 = { get: get };

  global.add('importcss', function (editor) {
    $_436tf9evjivb5dsd.setup(editor);
    return $_e588q3eujivb5ds9.get(editor);
  });
  function Plugin () {
  }
