...
var contextmenu = (function () {
  ...
  var $_4yyv8yajjivb5cvg = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_ano4laaijivb5cve.getContextMenu(editor);
  ...
  var $_cexk7kamjivb5cvl = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_ano4laaijivb5cve.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_cexk7kamjivb5cvl.show(editor, $_4yyv8yajjivb5cvg.getPos(editor, e), visibleState, menu);
    });
  };
  var $_fe79y7ahjivb5cvb = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_fe79y7ahjivb5cvb.setup(editor, visibleState, menu);
    return $_6wq66lagjivb5cv9.get(visibleState);
  });
  function Plugin () {
  }
