...
var help = (function () {
  ...
  var $_6jkdifbajivb5cya = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = map($_6jkdifbajivb5cya.shortcuts, function (shortcut) {
  ...
  var $_8ijfutb4jivb5cxb = { makeTab: makeTab };
  ...
  var $_bn4hy7bcjivb5cye = { makeTab: makeTab$1 };
  ...
  var $_2btbmdbijivb5czv = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_8ijfutb4jivb5cxb.makeTab(),
          $_bn4hy7bcjivb5cye.makeTab(editor)
        ],
        buttons: $_2btbmdbijivb5czv.makeRow(),
  ...
  var $_fbhluqb3jivb5cx8 = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_fbhluqb3jivb5cx8.open(editor, pluginUrl));
  };
  var $_f4lbobb2jivb5cx6 = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_fbhluqb3jivb5cx8.open(editor, pluginUrl)
    });
  ...
  var $_760dsrbkjivb5czx = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_760dsrbkjivb5czx.register(editor, pluginUrl);
    $_f4lbobb2jivb5cx6.register(editor, pluginUrl);
