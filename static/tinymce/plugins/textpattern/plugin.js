...
var textpattern = (function () {
  ...
  var $_398sltrhjivb5k20 = { getPatterns: getPatterns };
  ...
  var patternFromRng = function (patterns, rng, space) {
    ...
    var endPattern = $_e126chrpjivb5k2d.findEndPattern(patterns, text, rng.startOffset, delta);
    ...
    var startPattern = $_e126chrpjivb5k2d.findPattern(patterns, patternRng.toString());
  ...
  var applyBlockFormat = function (editor, patterns) {
    ...
    if (textBlockElm) {
      ...
      if (firstTextNode) {
        pattern = $_e126chrpjivb5k2d.findPattern(patterns, firstTextNode.data);
        if (!pattern) {
          return;
        }
  ...
  function handleEnter(editor, patterns) {
    ...
    wrappedTextNode = $_1wzqoyrmjivb5k28.applyInlineFormatEnter(editor, patterns);
    if (wrappedTextNode) {
    ...
    $_1wzqoyrmjivb5k28.applyBlockFormat(editor, patterns);
  }
  function handleInlineKey(editor, patterns) {
    var wrappedTextNode, lastChar, lastCharNode, rng, dom;
    wrappedTextNode = $_1wzqoyrmjivb5k28.applyInlineFormatSpace(editor, patterns);
    if (wrappedTextNode) {
      dom = editor.dom;
  ...
  var setup = function (editor, patternsState) {
    ...
    editor.on('keydown', function (e) {
      if (e.keyCode === 13 && !global$2.modifierPressed(e)) {
        $_8am4wzrljivb5k25.handleEnter(editor, patternsState.get());
      }
    }, true);
    editor.on('keyup', function (e) {
      if ($_8am4wzrljivb5k25.checkKeyCode(keyCodes, e)) {
        $_8am4wzrljivb5k25.handleInlineKey(editor, patternsState.get());
      }
    });
    editor.on('keypress', function (e) {
      if ($_8am4wzrljivb5k25.checkCharCode(charCodes, e)) {
  ...
  var $_cr9wwrijivb5k22 = { setup: setup };

  global.add('textpattern', function (editor) {
    var patternsState = Cell($_398sltrhjivb5k20.getPatterns(editor.settings));
    $_cr9wwrijivb5k22.setup(editor, patternsState);
    return $_9q6hm8rgjivb5k1y.get(patternsState);
  });
  function Plugin () {
  }
