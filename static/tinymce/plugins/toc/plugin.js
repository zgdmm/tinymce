...
var toc = (function () {
  ...
  var $_3ef9dkrzjivb5k44 = { create: create };

  var tocId = $_3ef9dkrzjivb5k44.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_g2t57pryjivb5k42.getTocClass(editor);
    var headerTag = $_g2t57pryjivb5k42.getTocHeader(editor);
    var selector = generateSelector($_g2t57pryjivb5k42.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_g2t57pryjivb5k42.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_g2t57pryjivb5k42.getTocHeader(editor), global$2.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_3270a9rujivb5k3v.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_3270a9rujivb5k3v.updateToc(editor);
    });
  };
  var $_6b8sbqrtjivb5k3s = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_g2t57pryjivb5k42.getTocClass(editor);
  ...
  var $_esact9s0jivb5k46 = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_3270a9rujivb5k3v.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_g2t57pryjivb5k42.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_1gqaids1jivb5k48 = { register: register$1 };

  global.add('toc', function (editor) {
    $_6b8sbqrtjivb5k3s.register(editor);
    $_1gqaids1jivb5k48.register(editor);
    $_esact9s0jivb5k46.setup(editor);
  });
  function Plugin () {
  }
