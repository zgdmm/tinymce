...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_7ofynga4jivb5csp.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_eg9ny79zjivb5cr8.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_3nttw5a1jivb5crb.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_9bej03a5jivb5cst = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_12iyan9yjivb5cr6 = {
    open: function (editor) {
      var minWidth = $_eg9ny79zjivb5cr8.getDialogMinWidth(editor);
      var minHeight = $_eg9ny79zjivb5cr8.getDialogMinHeight(editor);
      var currentLanguage = $_9bej03a5jivb5cst.getCurrentLanguage(editor);
      var currentLanguages = $_9bej03a5jivb5cst.getLanguages(editor);
      var currentCode = $_3nttw5a1jivb5crb.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_3nttw5a1jivb5crb.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_7ofynga4jivb5csp.isCodeSample(node)) {
        $_12iyan9yjivb5cr6.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_6ityah9xjivb5cr3 = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_7ofynga4jivb5csp.trimArg($_7ofynga4jivb5csp.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_7ofynga4jivb5csp.trimArg($_7ofynga4jivb5csp.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_9a4csva6jivb5csw = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_eg9ny79zjivb5cr8.getContentCss(editor);
  ...
  var $_6gcrjua7jivb5csz = { loadCss: loadCss };
  ...
  var $_af9whha8jivb5ct1 = { register: register$1 };

  var addedInlineCss = Cell(false);
  global.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_9a4csva6jivb5csw.setup(editor);
    $_af9whha8jivb5ct1.register(editor);
    $_6ityah9xjivb5cr3.register(editor);
    editor.on('init', function () {
      $_6gcrjua7jivb5csz.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_7ofynga4jivb5csp.isCodeSample(ev.target)) {
        $_12iyan9yjivb5cr6.open(editor);
      }
    });
  });
