...
var emoticons = (function () {
  ...
  var $_fzfztrayjivb5cwt = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_fzfztrayjivb5cwt.getHtml(pluginUrl);
  ...
  var $_b5552caxjivb5cwq = { register: register };

  global.add('emoticons', function (editor, pluginUrl) {
    $_b5552caxjivb5cwq.register(editor, pluginUrl);
  });
  function Plugin () {
  }
