...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_gb8t0sj3jivb5ea7.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_gb8t0sj3jivb5ea7.getPreviewDialogWidth(editor);
    var dialogHeight = $_gb8t0sj3jivb5ea7.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_4smzdaj4jivb5ea9.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_f9mrzpj1jivb5ea4 = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_f9mrzpj1jivb5ea4.open(editor);
    });
  };
  var $_14i7qhj0jivb5ea2 = { register: register };
  ...
  var $_dvep6zj6jivb5ead = { register: register$1 };

  global.add('preview', function (editor) {
    $_14i7qhj0jivb5ea2.register(editor);
    $_dvep6zj6jivb5ead.register(editor);
  });
  function Plugin () {
  }
