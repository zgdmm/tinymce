...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_312eje8rjivb5clt.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_312eje8rjivb5clt.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_312eje8rjivb5clt.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_312eje8rjivb5clt.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_312eje8rjivb5clt.getAutoResizeBottomMargin(editor);
    ...
    if ($_312eje8rjivb5clt.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_8yez8f8ojivb5clp.resize(editor, oldSize);
    });
  };
  var $_4o7yp08njivb5clm = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_4o7yp08njivb5clm.register(editor, oldSize);
      $_8yez8f8ojivb5clp.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
