...
var wordcount = (function () {
  ...
  var $_b3esl4t7jivb5kc4 = {
    each: each,
    map: map
  };

  var SETS$1 = $_c79jxst5jivb5kby.SETS;
  var OTHER = $_c79jxst5jivb5kby.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_b3esl4t7jivb5kc4.map(string.split(''), memoized);
  };
  var $_e7pxj6t6jivb5kc1 = { classify: classify };

  var ci = $_c79jxst5jivb5kby.characterIndices;
  ...
  var $_11cjqdt8jivb5kc6 = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_c79jxst5jivb5kby.EMPTY_STRING;
  var WHITESPACE$1 = $_c79jxst5jivb5kby.WHITESPACE;
  var PUNCTUATION$1 = $_c79jxst5jivb5kby.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_e7pxj6t6jivb5kc1.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_11cjqdt8jivb5kc6.isWordBoundary(map, i)) {
  ...
  var $_11oxtet4jivb5kbu = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_11oxtet4jivb5kbu.getWords(getTextContent(editor)).length;
  };
  var $_1ku2w3t3jivb5kbs = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_1ku2w3t3jivb5kbs.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_9pudrgt2jivb5kbq = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_1ku2w3t3jivb5kbs.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_amkb6pt9jivb5kc9 = { setup: setup };

  global.add('wordcount', function (editor) {
    $_amkb6pt9jivb5kc9.setup(editor);
    return $_9pudrgt2jivb5kbq.get(editor);
  });
  function Plugin () {
  }
