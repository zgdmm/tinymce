    ...
    <div>
        <div style="padding:20px">
            ...
            <div style="background:#fff;padding:20px">
                <div style="width: 100%;">
                    <p class="title">{{articleCode?'编辑行业动态':'新增行业动态'}}</p>
                    <!--新增经销商-->
...
// import image from '../../../static/tinymce/plugins/image/index'
export default {
    name: "noticeNew",
    components: {
    ...
    methods: {
        ...
        queryProduct(code) {
            const self = this;
            self.$http.post('/newsMng/queryNewsInfoByCode', { articleCode: code }, result => {
                if (result.code) {
                    ...
                    console.log(result.data.imgsList&&result.data.imgsList[0]&&result.data.imgsList[0].url||'','url')
                } else {
                    self.$message({
